...
// Feather 32u4
// Pinout: GND-GND 3V-VDD A0-OUT
// Uses onboard LED

// MICROPHONE TEST
// WIRING: (Trinket-Microphone) GND-GND 3V-VDD 0-OUT
// Measured values are clipped to [MIC_LO, MIC_HI]
#define MIC_LO 600  // Threshold for what we care about
...
//#endif
  ...
  Serial.begin(9600);
  pinMode(A0, INPUT);  // Read microphone
